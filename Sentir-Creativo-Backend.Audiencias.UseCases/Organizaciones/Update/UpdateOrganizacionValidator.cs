...
public class UpdateOrganizacionValidator : AbstractValidator<UpdateOrganizacionDto>
{
     public UpdateOrganizacionValidator()
     {
          RuleFor(p => p.Id).NotNull().WithMessage("El id es obligatorio");
          RuleFor(p => p.Nombre)
