...
public class ModoTrabajoConfiguration : IEntityTypeConfiguration<ModoTrabajo>
{
    public void Configure(EntityTypeBuilder<ModoTrabajo> builder)
    {
        builder.ToTable("modos_trabajos");
