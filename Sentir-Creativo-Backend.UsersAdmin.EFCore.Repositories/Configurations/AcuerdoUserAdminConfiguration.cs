...
public class AcuerdoUserAdminConfiguration :  IEntityTypeConfiguration<AcuerdoUserAdmin>
{
    public void Configure(EntityTypeBuilder<AcuerdoUserAdmin> builder)
    {
        builder.ToTable("acuerdos_useradmins");
