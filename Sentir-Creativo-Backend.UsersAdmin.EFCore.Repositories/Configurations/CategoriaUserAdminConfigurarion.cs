...
public class CategoriaUserAdminConfigurarion : IEntityTypeConfiguration<CategoriaUserAdmin>
{
    public void Configure(EntityTypeBuilder<CategoriaUserAdmin> builder)
    {
        builder.ToTable("categorias_useradmins");
