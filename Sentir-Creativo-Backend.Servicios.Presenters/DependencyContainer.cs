...
public static class DependencyContainer
{
    public static IServiceCollection AddServiciosPresenters(this IServiceCollection services)
    {
        ...
        services.AddScoped<UpdateFormatoPresenter>();
        services.AddScoped<IUpdateFormatoPresenter>(provider => provider.GetService<UpdateFormatoPresenter>());
        services.AddScoped<IUpdateFormatoOutputPort>(provider => provider.GetService<UpdateFormatoPresenter>());

        services.AddScoped<DeleteFormatoPresenter>();
        services.AddScoped<IDeleteFormatoPresenter>(provider => provider.GetService<DeleteFormatoPresenter>());
        services.AddScoped<IDeleteFormatoOutputPort>(provider => provider.GetService<DeleteFormatoPresenter>());

        services.AddScoped<GetAllFormatoPresenter>();
        services.AddScoped<IGetAllFormatoPresenter>(provider => provider.GetService<GetAllFormatoPresenter>());
        services.AddScoped<IGetAllFormatoOutputPort>(provider => provider.GetService<GetAllFormatoPresenter>());

        services.AddScoped<GetByIdFormatoPresenter>();
        services.AddScoped<IGetByIdFormatoPresenter>(provider => provider.GetService<GetByIdFormatoPresenter>());
        services.AddScoped<IGetByIdFormatoOutputPort>(provider => provider.GetService<GetByIdFormatoPresenter>());
